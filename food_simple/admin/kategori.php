...
if (isset($_POST['tambah'])) {
    ...
    if (empty($nama)) {
        echo "<script>alert('Nama kategori wajib diisi!'); window.location='kategori.php';</script>";
        exit();
    }
...
if (isset($_GET['edit'])) {
    $id        = $_GET['edit'];
    $r_edit    = mysqli_query($koneksi, "SELECT * FROM kategori WHERE id_kategori=$id");
    $data_edit = mysqli_fetch_assoc($r_edit);
}


$query  = "SELECT kategori.id_kategori, kategori.nama_kategori, COUNT(menu.id_menu) AS jml_menu 
           FROM kategori LEFT JOIN menu ON kategori.id_kategori = menu.id_kategori
           GROUP BY kategori.id_kategori, kategori.nama_kategori ORDER BY kategori.id_kategori DESC";
...
<div class="container py-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body">
                    <h6><?php if ($data_edit) { echo "Edit Kategori"; } else { echo "Tambah Kategori"; } ?></h6>
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_kategori" class="form-control"
                                   ...
                                   value="<?php if ($data_edit) { echo $data_edit['nama_kategori']; } ?>">
                        </div>
                        <div class="d-flex gap-2">
                            <?php if ($data_edit) { ?>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="kategori.php?edit=<?php echo $row['id_kategori']; ?>"
                                   class="btn btn-sm btn-warning">Edit</a>
                                <a href="kategori.php?hapus=<?php echo $row['id_kategori']; ?>"
